    ...
    public run(int: any): Promise<StatusMessage> {
        return new Promise(async (r) => {
            let embed = new EmbedBuilder()
                .setDescription("igor are artistuc <#=3")
                .setTimestamp()
                .setImage(
                    "https://cdn.discordapp.com/attachments/1044381780540653702/1236594599368196096/yippee.jpg?ex=6664be37&is=66636cb7&hm=7858f62f6e75a3c228f39d4308e0c5e757b8d2ff43285be657ebde08d91c7ddb&"
                )
                .setColor([121, 32, 245]);
