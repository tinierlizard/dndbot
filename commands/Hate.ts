    ...
    public run(int: any): Promise<StatusMessage> {
        return new Promise(async (r) => {
            let embed = new EmbedBuilder()
                ...
                .setTimestamp()
                .setImage(
                    "https://cdn.discordapp.com/attachments/1044381780540653702/1248906302789390446/autism.jpg?ex=66655e22&is=66640ca2&hm=b4b53c17b227c4fae79f45fc75e02c3a6d56a3c37dfb8203cf2410ffd0db6f2c&"
                )
                .setColor([173, 16, 16]);
